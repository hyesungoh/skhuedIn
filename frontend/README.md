...
<!--
1. 로그인 다음 프로세스 (재학, 졸업 > 재학년도 + 졸업년도 > )
2. 가입된 상태 + 졸업자 > 블로그 등록 버튼
> 블로그 등록 프로세스

3. 질문 마크다운으로 보여주기
4. 질문 작성 마크다운으로

5. 메인 페이지 로그인 안됐을 때, 왼쪽 상태



1. 라이브러리 컨테이너에서 setState
> setState한 값을 이용해서 peoplelist 뿌리기
> book에서 현재 book id 가져와서
> 새로운 질문 쓸 때 가지고 있어야함
> 새로운 질문 쓰는 모달 디자인

2. post 라우트에  포스트 글쓴이, 본문, 질문 게시판으로 넘어가게
